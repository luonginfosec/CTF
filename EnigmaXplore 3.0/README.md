...
Vì sever đã chết nên mình xin tóm tắt bài này như sau:

- Sử dụng kiến thức toán học để tìm lại công thức truy hồi bằng cách thử nhiều giá trị sau đó lập công thức tìm lại được công thức.

- Tính toán nhanh hơn là xong 
